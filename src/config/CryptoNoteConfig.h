...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 0x41ca;
    ...
    const char CRYPTONOTE_NAME[] = "ASCCoin";
    ...
    const int P2P_DEFAULT_PORT = 33897;

    const int RPC_DEFAULT_PORT = 33898;
